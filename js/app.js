var dataproject = {
    ...
    share: function(){
        $(".icon-twitter").on("click", function(){
            var tweet = "Graphics: Justice Department's investigation of Baltimore police"; //Tweet text
            var url = "http://data.baltimoresun.com/project/justice-report/index.html"; //Interactive URL
            var twitter_url = "https://twitter.com/intent/tweet?text="+tweet+"&url="+url+"&tw_p=tweetbutton";
            window.open(twitter_url, 'mywin','left=200,top=200,width=500,height=300,toolbar=1,resizable=0'); return false;
        });
        $(".icon-facebook").on("click", function(){
            var picture = "http://data.baltimoresun.com/project/justice-report/images/thumb-small.png"; //Picture URL
            var title = "Graphics: Justice Department's investigation of Baltimore police"; //Post title
            var description = "The Justice Dept found that police routinely violated the constitutional rights of residents"; //Post description
            var url = "http://data.baltimoresun.com/project/justice-report/index.html"; //Interactive URL
